...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        return temp.red == this.red && temp.green == this.green && temp.blue == this.blue;
    }

    //Uncomment this method after you've written equals and failed the testHashCodeAndEqualsConsistency test.
    @Override
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            return red + green + blue;
        } else {
            return red/5 + (green/5) * 53 + (blue/5) * 53 * 53; // chose a prime number as base
        }
    }
